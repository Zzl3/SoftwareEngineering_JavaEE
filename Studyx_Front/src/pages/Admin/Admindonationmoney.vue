  ...
  <Contentfield>
    <div>
      ...
      >
        ...
        <el-table-column prop="donationcost" label="捐款金额"  sortable width="150" :show-overflow-tooltip="true">
        </el-table-column>
        <el-table-column prop="donationtime" label="捐款时间" width="150" sortable>
        </el-table-column>
...
<script>
import Contentfield from "../../components/AdminCom/Contentfield";
